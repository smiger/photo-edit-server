							...
							<div class="col-xs-12">
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><a href="<?php echo U(edit);?>?aid=<?php echo ($val['id']); ?>"><i class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a href="javascript:;" val="<?php echo U('del');?>?aids=<?php echo ($val['id']); ?>" class="del"><i class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a></td>
