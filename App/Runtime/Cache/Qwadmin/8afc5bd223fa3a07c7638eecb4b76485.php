							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="title" id="title" class="col-xs-10 col-sm-5" value="<?php echo ($article['name']); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-10 col-sm-5"><?php echo UpImage("thumbnail",176,240,$article['image']);?></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="category" id="category" class="col-xs-10 col-sm-5" value="<?php echo ($article['category']); ?>">
										</div>
									</div>
