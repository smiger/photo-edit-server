<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <style type="text/css">
    *{ padding: 0; margin: 0; }
    body{ background: #FAFAFA; font-family: '微软雅黑'; color: #333; font-size: 14px; }
    .message{width: 400px; margin:auto; border:1px dashed #CCC; margin-top:5%; background:#fff; border-radius:10px;}
