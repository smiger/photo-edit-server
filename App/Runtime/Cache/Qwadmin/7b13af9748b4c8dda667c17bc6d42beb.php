						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="form" method="post" action="<?php echo U('del');?>">
									...
									<tbody> 
									<?php if(is_array($userList)): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
											<td style="line-height:30px"><?php echo ($val['xingming']); ?></td>
											<td style="line-height:30px"><?php echo ($val['tels']); ?></td>
                                            <td style="line-height:30px"><?php echo ($val['contents']); ?></td>
                                            <td style="line-height:30px"><?php echo ($val['title']); ?></td>
											<td style="line-height:30px"><?php echo (date("Y-m-d H:i:s",$val['datetime'])); ?></td>
                                            <td><a href="<?php echo U('del');?>?id=<?php echo ($val['id']); ?>" class="del"><i class="ace-icon fa fa-trash-o bigger-100 red"></i>删除</a></td>
